...
class Screen8(object):
    ...
    def draw(self, screen):
        ...
        text = font.render("Question 8", 1, (255, 255, 0))
        ...
        q2 = font.render("dog in The Nightmare Before Christmas?", 1, (255, 255,0))
        q2_pos = q2.get_rect()
        q2_pos.top = q_pos.top + 35
        screen.blit(q2, q2_pos)

        a1 = font.render("a. Fido", 1, (255, 255, 0))
        a1_pos = a1.get_rect()
        a1_pos.top = q2_pos.top + 45
        screen.blit(a1, a1_pos)

        a2 = font.render("b. Digger", 1, (255, 255, 0))
        a2_pos = a2.get_rect()
        a2_pos.top = a1_pos.top + 35
        screen.blit(a2, a2_pos)

        a3 = font.render("c. Mike", 1, (255, 255, 0))
        a3_pos = a3.get_rect()
        a3_pos.top = a2_pos.top + 35
        screen.blit(a3, a3_pos)

        a4 = font.render("d. Zero", 1, (255, 255, 0))
        a4_pos = a4.get_rect()
    ...
    def update(self, keys):
        ...
        if keys[pygame.K_d]:
            return True
        elif keys[pygame.K_b] or keys[pygame.K_c] or keys[pygame.K_a]:
