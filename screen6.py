...
class Screen6(object):
    ...
    def draw(self, screen):
        ...
        q2 = font.render("that can kill a vampire?", 1, (255, 255,0))
        q2_pos = q2.get_rect()
        q2_pos.top = q_pos.top + 35
        screen.blit(q2, q2_pos)

        a1 = font.render("a. Holy Water", 1, (255, 255, 0))
        a1_pos = a1.get_rect()
        a1_pos.top = q2_pos.top + 45
        screen.blit(a1, a1_pos)

        a2 = font.render("b. An Oak Stake", 1, (255, 255, 0))
        a2_pos = a2.get_rect()
        a2_pos.top = a1_pos.top + 35
        screen.blit(a2, a2_pos)

        a3 = font.render("c. Onions", 1, (255, 255, 0))
        a3_pos = a3.get_rect()
        a3_pos.top = a2_pos.top + 35
        screen.blit(a3, a3_pos)

        a4 = font.render("d. Sunlight", 1, (255, 255, 0))
        a4_pos = a4.get_rect()
